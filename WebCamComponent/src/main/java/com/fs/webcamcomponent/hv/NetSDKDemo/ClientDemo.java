package com.fs.webcamcomponent.hv.NetSDKDemo;

import com.fs.webcamcomponent.hv.Common.osSelect;
...
public class ClientDemo {
        ...
        if (playControl == null) {
            synchronized (PlayCtrl.class) {
                ...
                try {
                    if (osSelect.isWindows())
                        //win系统加载库路径
                        strPlayPath = System.getProperty("user.dir") + "\\lib\\HV_lib\\PlayCtrl.dll";
                    else if (osSelect.isLinux())
                        //Linux系统加载库路径
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        login_V40("192.168.1.64",(short) 8000,"admin","fs123456");
